...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2022 at 07:41 PM
...
(7, '...........', '2022-08-12 21:00:00', 1, 1, 'Kempinski Hotel Ishtar Dead Sea', 8, 'Dana');
...
--
-- Table structure for table `restaurants_reservations`
--

CREATE TABLE `restaurants_reservations` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `user_name` varchar(255) NOT NULL,
  `user_phone` bigint(20) NOT NULL,
...
--
-- Indexes for table `restaurants_reservations`
--
ALTER TABLE `restaurants_reservations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `rest_id` (`rest_id`),
  ADD KEY `restaurants_reservations_ibfk_1` (`user_id`);
...
--
-- AUTO_INCREMENT for table `restaurants_reservations`
--
ALTER TABLE `restaurants_reservations`
...
--
-- Constraints for table `restaurants_reservations`
--
ALTER TABLE `restaurants_reservations`
  ADD CONSTRAINT `rest_id` FOREIGN KEY (`rest_id`) REFERENCES `hotels` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `restaurants_reservations_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
