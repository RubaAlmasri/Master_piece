                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                                <div class="d-md-flex">
                                    ...
                                    <a href="add_user.php" class="btn btn-primary d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white">Add User
                                    </a>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form method="post" action="delete_user.php" class="d-inline">
                                                                <input type="hidden" value="<?php echo $i['user_id']; ?>" name="id">
