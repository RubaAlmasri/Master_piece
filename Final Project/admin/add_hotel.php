                                        ...
                                        <div class="card-body p-5">
                                            <div class="mb-md-5 mt-md-4">
                                                <form action="add.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-outline form-white mb-4" style="text-align: left;">
                                                        <label for="file"><b>Image 1:</b> <span style="color: red;">*</span></label>
                                                        <input type="file" class="form-control-file form-control" id="file" name="file" accept="image/*" required>
                                                    </div>
                                                    <div class="form-outline form-white mb-4" style="text-align: left;">
                                                        <label for="file"><b>Image 2:</b> <span style="color: red;">*</span></label>
                                                        <input type="file" class="form-control-file form-control" id="file" name="file" accept="image/*" required>
                                                    </div>
                                                    <div class="form-outline form-white mb-4" style="text-align: left;">
                                                        <label for="file"><b>Image 3:</b> <span style="color: red;">*</span></label>
                                                        <input type="file" class="form-control-file form-control" id="file" name="file" accept="image/*" required>
                                                    </div>
                                                    <div class="form-outline form-white mb-4" style="text-align: left;">
                                                        <label for="file"><b>Image 4:</b> <span style="color: red;">*</span></label>
                                                        <input type="file" class="form-control-file form-control" id="file" name="file" accept="image/*" required>
                                                    </div>
