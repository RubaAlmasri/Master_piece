	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 mt-20">
				...
				<p>The main goal is to provide suggestions for tourist places in Jordan in all cities with their locations.</p>
				<p>In addition to providing the best hotels in various cities, where people can book in it through the website.</p>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				...
				<p>If you have any question, send us a message...</p>
				<a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn btn-main" href="service.php">Contact Us</a>
